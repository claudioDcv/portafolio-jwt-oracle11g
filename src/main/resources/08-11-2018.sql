...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SAFE_USER"."INFORME_DETALLE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence OBSERVACIO_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SAFE_USER"."OBSERVACIO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into SAFE_USER.OBSERVACIONES (NOMBRE,ID_OBSERVACION,INFORME_DETALLE_FK) values ('Tornillo suelto','1','1');
Insert into SAFE_USER.OBSERVACIONES (NOMBRE,ID_OBSERVACION,INFORME_DETALLE_FK) values ('Tuerca rodada','2','1');
Insert into SAFE_USER.OBSERVACIONES (NOMBRE,ID_OBSERVACION,INFORME_DETALLE_FK) values ('Falta aceite','3','1');
