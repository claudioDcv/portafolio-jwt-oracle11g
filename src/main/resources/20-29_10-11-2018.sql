...
Insert into SAFE_USER.INFORMES_DETALLES (INFORME_DETALLE_ID,PREVENSIONISTA_FK,TECNICO_FK,NOMBRE,SUPERVISOR_FK,FECHA_REALIZACION,CONFIRMACION_PREVENCIONISTA,FECHA_APROBACION,SOLICITAR_REVISION) values ('53',null,'1','HOla','35',to_date('22/11/18','DD/MM/RR'),'0',null,'0');
...
OPEN o_cursor FOR
            SELECT solicitar_revision, informe_instalacion_id as id, informe_detalle_fk as detalle, instalacion_fk as instalacion,  confirmacion_prevencionista, fecha_aprobacion as fecha_confirmacion, fecha_realizacion, nombre, prevensionista_fk as prevencionista, supervisor_fk as supervisor, tecnico_fk as tecnico
